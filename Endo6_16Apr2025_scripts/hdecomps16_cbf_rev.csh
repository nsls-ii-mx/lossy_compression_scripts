...
set oldcbffile=`echo ${nfile}|sed s/u2hdecomps16/u2encI/|sed s/_smoothed//`
...
rm hdecomps16_cbf_rev/head_$oldcbffile hdecomps16_cbf_rev/tail_$nfile
rm hdecomps16_cbf_rev/$cbfile
end
